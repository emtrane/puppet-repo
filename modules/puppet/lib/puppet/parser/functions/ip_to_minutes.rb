...
#
# example usage
# ip_to_minutes()     - returns one value between 0..59
# ip_to_minutes(2)    - returns an array of two values between 0..59
# ip_to_minutes(2,24) - returns an array of two values between 0..23

module Puppet::Parser::Functions
    newfunction(:ip_to_minutes, :type => :rvalue) do |args|
